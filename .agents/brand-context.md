...
> **Status:** v1 — foundation. Created 2026-08-23.
...
- Chosen because this is the audience that (a) makes the "digital world" name
  coherent, (b) sits next to Production X's real competence so the brand can be
...
- **Key Problem** (audience): They make consequential decisions from material
  ...
  costs them hours of triangulating takes.
- **Their Language**: "what actually works", "is this real or hype", "show me the
  numbers", "who's using it in production", "I don't have time to test this",
...
## Brand Personality
- **Personality Words**: Rigorous, candid, unhurried, useful, self-correcting
- **Tone**: Formal-leaning but human. Serious, never solemn. Dry rather than witty.
- **Voice Admires**: The Economist (institutional authority without a byline cult),
  Stratechery (argument shown, not asserted), Bloomberg (precision as a habit)
- **Never sounds like**: hype newsletters, LinkedIn thought-leadership voice,
  press-release English, breathless launch coverage

## Values & Mission
- **Core Values**:
  1. **Verify before publishing** — an unsourced claim is not content, it's a rumour
  2. **Name the conflict** — sponsors and stakes are disclosed, always, unprompted
  3. **Revisit what changes** — publishing is not the end of the obligation
  4. **Say what we don't know** — admitted uncertainty is the premium, not a weakness
  5. **Useful over interesting** — if a reader can't act on it, it doesn't run
- **Mission**: To make the digital economy legible to the people building in it —
