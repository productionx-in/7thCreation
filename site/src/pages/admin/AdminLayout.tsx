...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-ink">
      <header className="flex items-center justify-between border-b border-[#767F83]/15 px-5 py-4 sm:px-8">
        <Link to="/admin" className="flex items-center gap-3">
          <Logo className="h-7 w-7" />
          <span className="font-display text-sm uppercase tracking-[0.3em] text-[#E6DECD]">Studio</span>
        </Link>
        <div className="flex items-center gap-5 text-xs uppercase tracking-widest text-[#767F83]">
